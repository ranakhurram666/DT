...
export default class EpisodesDetails extends React.Component {
 constructor() {
        super();
        this.state = {
           totalListeners: [
            ...
            <div className="tablular-data-wrapper">
              ...
              <thead> 
                <tr> 
                  <th>Episode Name</th> 
                  <th>Total Plays</th> 
                  <th>Complete Plays</th> 
                  <th>Partial Plays</th> 
                </tr> 
              </thead>   
              <tbody> 
                <tr> 
                  <th scope="row">Faarishta E.01</th> 
                    <TotalListItem total={'34,597'} rise={true} percentValue={10.6}/>
                  <td>21,630</td>
                  <td>12,967</td> 
                </tr> 
